...
public class AllEmployeeInfo implements ActionListener 
{
	...
	public AllEmployeeInfo() 
	{
        ...
        try
        {
        	...
        	ResultSet rs = conn.statement.executeQuery("select * from HotelEmployees order by EMPID");
        ...
        com2=new JComboBox<String>(jobList);
...
//...........Adding Employee info from database to JPanel..........................
        ...
        try
        {
        	...
        	String str="select * from HotelEmployees order by EMPID";
			...
			if(com1.getSelectedItem()!="")
			{
				...
				try
			    {
					...
					Vector<Object> rows = null;
			       	...
			       	str="select * from HotelEmployees where EMPID='"+com1.getSelectedItem()+"' order by EMPID";
			...
			else
			{
				...
				try
			    {
					...
					Vector<Object> rows = null;
			       	...
			       	str="select * from HotelEmployees where JOB='"+com2.getSelectedItem()+"' order by EMPID";
